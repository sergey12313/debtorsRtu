...
function commentString(item,toggle) {
    return `Tne number ${item} was turned ${toggle} automatically ${moment().format("lll")}`;
}
...
XmlStringGen.prototype.setDebNum=function () {
    return new Promise(resolve=>{
        ...
        this._obj.commands.command.item.comment=commentString(this._num,'off');
        //this._obj.commands.command.item.comment="test";
...
XmlStringGen.prototype.setCapacityAndGroups=function (obj) {
    return new Promise(resolve=>{
        ...
        this._obj.commands.command.item.comment=commentString(this._num,'on');
        //this._obj.commands.command.item.comment="test";
